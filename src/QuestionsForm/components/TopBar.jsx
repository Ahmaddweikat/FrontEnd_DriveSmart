  ...
  return (
    <div className="bg-white shadow p-4 flex justify-between items-center  h-16 sticky top-0 z-50">
      <div className="relative flex items-center w-1/2">
        ...
        <button className="text-gray-600 hover:text-green-700 flex items-center font-medium text-base mx-4">
        ...
        >
          <button
            className={`text-gray-600 flex items-center mr-2 font-medium text-base ${
              showTheoryQuestions ? "text-green-600" : "hover:text-green-700"
            }`}
          >
        ...
        >
          <button
            className={`text-gray-600 flex items-center font-medium text-base mr-2 ${
              showTheoryLearning ? "text-green-600" : "hover:text-green-700"
            }`}
          >
        ...
        >
          <button
            className={`text-gray-600 flex items-center font-medium text-base ${
              showInquiryAbout ? "text-green-600" : "hover:text-green-700"
            }`}
          >

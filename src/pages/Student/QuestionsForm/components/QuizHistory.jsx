...
const QuizHistory = ({ formName, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl max-w-lg w-full mx-4 transform shadow-2xl border-2 border-green-200 h-[600px] overflow-hidden">
        ...
        <div className="p-6 pt-4 overflow-y-auto h-[calc(100%-100px)]">
          {history.length === 0 ? (

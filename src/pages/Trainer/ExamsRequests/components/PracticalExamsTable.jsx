...
const PracticalExamsTable = ({ 
  ...
  const getLessonsTakenColor = (lessonsTaken) => {
    if (lessonsTaken >= 20) return 'bg-green-100 text-green-800';
    if (lessonsTaken >= 15) return 'bg-yellow-100 text-yellow-800';
  ...
  return (
    <Box>
              ...
              {requests.length > 0 ? (
                  ...
                  <TableRow key={request.id} hover>
                    ...
                    <TableCell sx={bodyCellStyle}>
                      <div className="flex items-center justify-center">
                        <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getLessonsTakenColor(request.lessonsTaken)}`}>
                          {request.lessonsTaken} lessons
                        </span>
                      </div>
                    </TableCell>
                    <TableCell sx={bodyCellStyle}>
                ...
                <TableRow>
                  <TableCell 
                    ...
                    sx={{ py: 4 }}
                  >
                    <p className="text-gray-500">No practical exam requests available</p>
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
      ...
      <Dialog open={confirmDialog.open} onClose={handleClose}>
        ...
        <DialogContent>
          Are you sure you want to {confirmDialog.action} the practical exam request for{' '}
...
export default PracticalExamsTable;

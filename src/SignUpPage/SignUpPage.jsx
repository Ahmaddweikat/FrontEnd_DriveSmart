...
function SignUpPage() {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md p-10 bg-white text-center rounded-lg shadow-lg mx-4">
        {/* Logo inside the input panel */}
        <div className="flex justify-start">
          <img src={Logo} alt="Logo" className="h-30 w-36 mt-8 mr-8" />
        </div>
        ...
        <p className="mt-6 text-sm text-gray-600">
          ...
          <Link to="/signup" className="text-customGreen underline-shrink">
            Sign up
          </Link>
        </p>
        {/* OR Separator */}
